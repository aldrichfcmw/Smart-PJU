...
<html lang="en">
  ...
  <body>
    ...
    <script>
      ...
      var bulb_err = new H.map.Icon("assets/images/icon/light-bulb-err.png", { size: { w: 18, h: 30 } });
      var bulb_off = new H.map.Icon("assets/images/icon/light-bulb-off.png", { size: { w: 18, h: 30 } });
      var bulb_on = new H.map.Icon("assets/images/icon/light-bulb-on.png", { size: { w: 18, h: 30 } });
